...
public class AspectRatioMeasureTest {
  ...
  public void testAspectRatio() {
    ...
    assertThat(mSpec.width).isEqualTo(makeMeasureSpec(460, EXACTLY));
    assertThat(mSpec.height).isEqualTo(makeMeasureSpec(310, EXACTLY));
    ...
    assertThat(mSpec.width).isEqualTo(makeMeasureSpec(410, EXACTLY));
    assertThat(mSpec.height).isEqualTo(makeMeasureSpec(210, EXACTLY));
  }
  ...
  public void testNoAspectRatio() {
    ...
    assertThat(mSpec.width).isEqualTo(makeMeasureSpec(410, UNSPECIFIED));
    assertThat(mSpec.height).isEqualTo(makeMeasureSpec(310, EXACTLY));
    ...
    assertThat(mSpec.width).isEqualTo(makeMeasureSpec(410, EXACTLY));
    assertThat(mSpec.height).isEqualTo(makeMeasureSpec(310, UNSPECIFIED));
  }
  ...
  public void testAtMost() {
    ...
    assertThat(mSpec.width).isEqualTo(makeMeasureSpec(410, EXACTLY));
    assertThat(mSpec.height).isEqualTo(makeMeasureSpec(110, EXACTLY));
