...
object VitoSpinners {
  ...
  fun placeholderOptions(resources: Resources) = Pair(
      listOf(
          "none" to { builder: ImageOptions.Builder -> builder.placeholder(null) },
          "image" to
              { builder: ImageOptions.Builder ->
                builder.placeholderRes(R.drawable.logo, ScalingUtils.ScaleType.FIT_CENTER)
              },
          "block color" to
              { builder: ImageOptions.Builder ->
  ...
  val overlayOptions = Pair(
      listOf(
          ...
          "orange color res" to
              { builder: ImageOptions.Builder ->
                builder.overlayRes(R.color.overlay_color)
              },
          "green color drawable" to
              { builder: ImageOptions.Builder ->
                builder.overlay(ColorDrawable(0x8800ff00.toInt()))
              },
          "9-patch" to
              { builder: ImageOptions.Builder ->
  ...
  val postprocessorOptions = Pair(
      listOf(
          "none" to { builder: ImageOptions.Builder -> builder.postprocess(null) },
          "Grey Scale Post-Processor(Slow)" to
              { builder: ImageOptions.Builder ->
                builder.postprocess(SlowGreyScalePostprocessor())
              },
          "Grey Scale Post-Processor" to
              { builder: ImageOptions.Builder ->
                builder.postprocess(FasterGreyScalePostprocessor())
              },
          "Watermark Post-Processor" to
              { builder: ImageOptions.Builder ->
                builder.postprocess(WatermarkPostprocessor(10, "FRESCO"))
              },
          "Watermark Post-Processor(Cached)" to
              { builder: ImageOptions.Builder ->
                builder.postprocess(CachedWatermarkPostprocessor(10, "FRESCO"))
              },
          "Native Blur Post-Processor" to
              { builder: ImageOptions.Builder ->
                builder.postprocess(IterativeBoxBlurPostProcessor(25, 3))
              },
          "Scaling Blur Post-Processor" to
              { builder: ImageOptions.Builder ->
                builder.postprocess(ScalingBlurPostprocessor(25, 3, 4))
              },
          "Native Round As Circle Postprocessor" to
              { builder: ImageOptions.Builder ->
                builder.postprocess(RoundAsCirclePostprocessor(false))
              },
          "Antialiased As Circle Postprocessor" to
              { builder: ImageOptions.Builder ->
                builder.postprocess(RoundAsCirclePostprocessor(true))
              },
  ...
  val customDrawableFactoryOptions = Pair(
      listOf(
  ...
  val resizeOptions = Pair(
      listOf(
          "none" to { builder: ImageOptions.Builder -> builder.resize(null) },
          "100 x 100" to
              { builder: ImageOptions.Builder ->
                builder.resize(ResizeOptions.forSquareSize(100))
              },
          "500 x 500" to
              { builder: ImageOptions.Builder ->
                builder.resize(ResizeOptions.forSquareSize(500))
              },
          "1000 x 1000" to
              { builder: ImageOptions.Builder ->
                builder.resize(ResizeOptions.forSquareSize(1000))
              },
          "200 x 100" to
              { builder: ImageOptions.Builder ->
                builder.resize(ResizeOptions.forDimensions(200, 100))
              },
          "500 x 100" to
              { builder: ImageOptions.Builder ->
                builder.resize(ResizeOptions.forDimensions(500, 100))
              },
          "500 x 400" to
              { builder: ImageOptions.Builder ->
                builder.resize(ResizeOptions.forDimensions(500, 400))
              },
          "800 x 600" to
              { builder: ImageOptions.Builder ->
                builder.resize(ResizeOptions.forDimensions(800, 600))
              },
          "600 x 800 " to
              { builder: ImageOptions.Builder ->
                builder.resize(ResizeOptions.forDimensions(600, 800))
              },
          "960 x 720" to
              { builder: ImageOptions.Builder ->
                builder.resize(ResizeOptions.forDimensions(960, 720))
              },
          "1280 x 720" to
              { builder: ImageOptions.Builder ->
                builder.resize(ResizeOptions.forDimensions(1280, 720))
              },
          "1280 x 800" to
              { builder: ImageOptions.Builder ->
                builder.resize(ResizeOptions.forDimensions(1280, 800))
              },
          "1920 x 1080" to
              { builder: ImageOptions.Builder ->
                builder.resize(ResizeOptions.forDimensions(1920, 1080))
              },
          "1080 x 1920" to
              { builder: ImageOptions.Builder ->
                builder.resize(ResizeOptions.forDimensions(1080, 1920))
              },
          "3840 x 2160" to
              { builder: ImageOptions.Builder ->
                builder.resize(ResizeOptions.forDimensions(3840, 2160))
              },
          "4096 x 2160" to
              { builder: ImageOptions.Builder ->
                builder.resize(ResizeOptions.forDimensions(4096, 2160))
              },
          "2160 x 4096" to
              { builder: ImageOptions.Builder ->
