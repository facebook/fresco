...
public @interface SourceUriType {
  ...
  final int SOURCE_TYPE_UNKNOWN = -1;
  final int SOURCE_TYPE_NETWORK = 0;
  final int SOURCE_TYPE_LOCAL_FILE = 1;
  final int SOURCE_TYPE_LOCAL_VIDEO_FILE = 2;
  final int SOURCE_TYPE_LOCAL_IMAGE_FILE = 3;
  final int SOURCE_TYPE_LOCAL_CONTENT = 4;
  final int SOURCE_TYPE_LOCAL_ASSET = 5;
  final int SOURCE_TYPE_LOCAL_RESOURCE = 6;
  final int SOURCE_TYPE_DATA = 7;
  final int SOURCE_TYPE_QUALIFIED_RESOURCE = 8;
}
